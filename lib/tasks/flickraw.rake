...
namespace :flickraw do
  ...
  task :upload_images => :environment do
    ...
    image_to_upload = Image.published.from_published_albums.readonly(false).
  ...
  task :update_images_data => :environment do
    ...
    images_to_update = Image.published.from_published_albums.readonly(false).
  ...
  task :post_comments_to_disqus => :environment do
    ...
    images = Image.published.from_published_albums.readonly(false).where('images.flickr_photo_id != ""')
